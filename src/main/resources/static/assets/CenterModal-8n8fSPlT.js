import{r as o,j as e,B as l}from"./index-BldMvkj-.js";const i=({handleClickCancle:t,handleClickSubmit:n,content:s=null})=>{const r=()=>{t()},x=a=>{a.stopPropagation()};return e.jsx("div",{className:`fixed top-0 left-[50%] translate-x-[-50%] z-10\r
